...
public class BackstagePasses {
    @Test
    void test15days() {
        Item[] code = {new Item("Backstage passes for Re:Factor", 15, 20)};
    ...
    @Test
    void test10days() {
        Item[] code = {new Item("Backstage passes for Re:Factor", 11, 20)};
        GildedTros gildedTros = new GildedTros(code);
    ...
    @Test
    void test5days() {
        Item[] code = {new Item("Backstage passes for Re:Factor", 6, 20)};
        GildedTros gildedTros = new GildedTros(code);
    ...
    @Test
    void test0days() {
        Item[] code = {new Item("Backstage passes for Re:Factor", 2, 20)};
        GildedTros gildedTros = new GildedTros(code);
